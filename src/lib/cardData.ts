...
export const propertyCards: PropertyCard[] = [
  ...
  ...Array(7).fill(null).map((_, i) => ({
    ...
    specialAbility: 'Can build >4 stories: Cost 12M, Income 6M, Bank 4M, End Game 12M, Influence -1',
  ...
  },
  {
    ...
    specialAbility:
      ...
      'Build cost matches the anchor you choose (bank $5M).\n' +
      'Screen notification matches the anchor you chose.\n' +
      'Build: Pick the anchor in the hand dialog, then place on valid lots for that anchor. Union may use any vacant Anchor Tenet lot; the former Union spaces at S11, C11, K19, and K3 are open to every anchor.',
    category: 'anchor'
  },
  {
    id: 'union',
...
export const actionCards: ActionCard[] = [
  ...
  },
  {
    ...
    copies: 8,
    diceRequired: true,
    diceRollRule: '5–6 approves; +1 influence makes 4–6 approve; +2 makes 3–6 approve',
  ...
  },
  {
    ...
    actions:
      'Pay $1M to the property owner and roll the die. Anchor tenets modify Hostile Takeover only using the target property’s city block (district anchors, Mafia, Regulation Bureau, etc.; combine per printed rules). Natural roll: 5–6 succeeds; +1 influence makes 4–6 succeed; +2 makes 3–6 succeed. The owner then rolls once and only a 6 blocks; otherwise pay 120% of property value and take ownership.',
  },
  {
    id: 'scandal',
    type: 'action',
  ...
  },
  {
    ...
    description: 'Immediate property-value assessment on all other founders',
    buildCost: 0,
    buildIncome: 0,
    bankValue: 5,
    copies: 4,
  ...
  },
  {
    ...
    category: 'calamity',
    name: 'Calamity',
    description: 'City-wide crisis — every founder rolls immediately',
    buildCost: 0,
    buildIncome: 0,
    bankValue: 0,
    copies: 3,
