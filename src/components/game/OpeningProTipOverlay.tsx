  ...
  return (
    ...
    >
      ...
      >
        ...
        `}</style>
        <ol
          className="fs-opening-pro-tip-list m-0 flex min-h-0 flex-1 list-decimal flex-col justify-center overflow-hidden px-[clamp(0.75rem,2.5%,1.25rem)] pt-[clamp(0.5rem,2%,1rem)] pb-[clamp(0.85rem,2.5vh,1.35rem)]"
          style={{
        ...
        <div className="flex shrink-0 justify-end border-t border-sky-400/25 px-[clamp(0.75rem,2.5%,1.25rem)] pt-[clamp(0.35rem,1.2%,0.55rem)] pb-[clamp(0.65rem,2.2%,1rem)]">
          <button
            type="button"
            onClick={onSkip}
            className="rounded-lg border border-sky-400/45 bg-sky-950/60 px-4 py-1.5 text-[clamp(0.7rem,1.6vw,0.85rem)] font-semibold uppercase tracking-[0.14em] text-sky-100 transition-colors hover:border-sky-300/70 hover:bg-sky-900/70 hover:text-white"
          >
            Skip
          </button>
        </div>
...
export const OPENING_PRO_TIP_DURATION_MS = 10_000
